...
public class Spawn1to5 {
	...
	public void tick() {
		 ...
		 */
			...
			levelTimer--;
			if (tempCounter < 1) {
				handler.addObject(new EnemyShooter(r.nextInt(((Game.WIDTH - 50) - 50) + 1 )+ 50 - 100, r.nextInt(((Game.HEIGHT - 50) - 50) + 1 )+ 50 -100, 100, 100, -20, ID.EnemyShooter, this.handler));
				levelTimer = 1200;
				tempCounter++;
			}
			...
			if (spawnTimer == 0) {
				handler.addObject(new EnemyExpand(r.nextInt(((Game.WIDTH - 50) - 50) + 1 )+ 50 - 35, r.nextInt(((Game.HEIGHT - 50) - 50) + 1 )+ 50 - 75, 100, 100, ID.EnemyExpand, this.handler));
				spawnTimer = 50;
			}
			if (levelTimer == 0) {
				tempCounter = 0;
			...
			if(spawnTimer == 0) {
				handler.addObject(new EnemyMiniShooter(r.nextInt(((Game.WIDTH - 50) - 50) + 1 )+ 50 - 35, r.nextInt(((Game.HEIGHT - 50) - 50) + 1 )+ 50 - 75, 75, 75, -10, ID.EnemyMiniShooter, this.handler, this.game));
				handler.addObject(new EnemyMiniShooter(r.nextInt(((Game.WIDTH - 50) - 50) + 1 )+ 50 - 35, r.nextInt(((Game.HEIGHT - 50) - 50) + 1 )+ 50 - 75, 75, 75, -10, ID.EnemyMiniShooter, this.handler, this.game));
				handler.addObject(new EnemyMiniShooter(r.nextInt(((Game.WIDTH - 50) - 50) + 1 )+ 50 - 35, r.nextInt(((Game.HEIGHT - 50) - 50) + 1 )+ 50 - 75, 75, 75, -10, ID.EnemyMiniShooter, this.handler, this.game));
			}
			if (levelTimer == 0) {
			...
			if(spawnTimer == 0) {
				handler.addObject(new EnemyPorcupine(r.nextInt(((Game.WIDTH - 50) - 50) + 1 )+ 50 - 35, r.nextInt(((Game.HEIGHT - 50) - 50) + 1 )+ 50 - 75, 100, 100, ID.EnemyPorcupine, this.handler, -1, -2, this.game));
				handler.addObject(new EnemyPorcupine(r.nextInt(((Game.WIDTH - 50) - 50) + 1 )+ 50 - 35, r.nextInt(((Game.HEIGHT - 50) - 50) + 1 )+ 50 - 75, 100, 100, ID.EnemyPorcupine, this.handler, -1, -2, this.game));
			}
			if (levelTimer == 0) {
				tempCounter = 0;
			...
			if (spawnTimer == 0) {
				handler.addObject(new EnemyMoveRight(r.nextInt(((Game.WIDTH - 50) - 50) + 1 )+ 50 - 35, r.nextInt(((Game.HEIGHT - 50) - 50) + 1 )+ 50 - 75, 75, 75, ID.EnemyMove, this.handler));
				handler.addObject(new EnemyMoveLeft(r.nextInt(((Game.WIDTH - 50) - 50) + 1 )+ 50 - 35, r.nextInt(((Game.HEIGHT - 50) - 50) + 1 )+ 50 - 75, 75, 75, ID.EnemyMove, this.handler));
				spawnTimer = 25;
			}
			if (levelTimer == 0) {
				tempCounter = 0;
